...
VALUES
    ...
    ('revolver_standard', 'Revolver Ammunition', 'Standard ammunition for revolvers.', 200, 50, 0.00, 0, 2, 'item_ammo', 'stack'),
    ('weapon_repair_kit', 'Weapon Repair Kit', 'Materials used to repair a damaged weapon.', 20, 10, 1.00, 1, 8, 'item_item', 'stack'),
    ('cattleman_long_barrel', 'Cattleman Long Barrel', 'A long barrel made for the Cattleman Revolver.', 20, 10, 1.00, 1, 3, 'item_item', 'stack')
